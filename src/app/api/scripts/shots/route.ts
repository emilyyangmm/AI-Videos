...
7. **⚠️ 必须包含中国元素**：每个英文提示词末尾必须加上：
   - 人物场景：Chinese people, Asian appearance, East Asian facial features
   - 场景描述：Chinese urban environment, Chinese store interior, China setting
   - 固定结尾：Chinese style, China setting
   
   示例：如果提示词是"A woman walking in a store"，必须改为"A Chinese woman with East Asian facial features walking in a Chinese store interior, Chinese style, China setting"
`;
